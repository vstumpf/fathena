...
struct script_reg_state {
	uint32 type : 1; // because I'm a memory hoarder and having them in the same struct would be a 8-byte/instance waste
					 // while ints outnumber str on a 10000-to-1 ratio.
