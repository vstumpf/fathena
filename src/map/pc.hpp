...
public:
	...
	int16 setlook_head_top, setlook_head_mid, setlook_head_bottom,
...
enum e_additem_result pc_additem(
	map_session_data *sd, struct item *item, int32 amount, e_log_pick_type log_type, bool favorite = false);
