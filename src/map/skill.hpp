...
enum e_dance_overlap : int32 {
	OVERLAP_REMOVE =
		0, // Skill unit is about to be removed, remove overlap marker from overlapping units on the cell if applicable
...
int32 skill_elementalanalysis(map_session_data &sd,
							  int32 n,
							  uint16 skill_lv,
							  uint16 *item_list); // Sorcerer Four Elemental Analisys.
