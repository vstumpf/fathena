...
struct status_data {
	...
	uint32 max_sp;
	uint32 max_ap;
	int16 str, agi, vit, int_, dex, luk, pow, sta, wis, spl, con, crt, eatk;
	int32 batk;
	uint16
#ifdef RENEWAL
		watk,
...
static bool sc_start2(block_list *src,
					  block_list *bl,
					  sc_type type,
					  int32 rate,
					  int32 val1,
...
static bool sc_start4(block_list *src,
					  block_list *bl,
					  sc_type type,
					  int32 rate,
					  int32 val1,
