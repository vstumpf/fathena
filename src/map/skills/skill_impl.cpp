...
void SkillImpl::castendNoDamageId(
...
void SkillImplRecursiveDamageSplash::castendDamageId(
	block_list* src, block_list* target, uint16 skill_lv, t_tick tick, int32& flag) const {
...
void SkillImplRecursiveDamageSplash::castendPos2(
	block_list* src, int32 x, int32 y, uint16 skill_lv, t_tick tick, int32& flag) const {
...
void SkillImplRecursiveDamageSplash::splashSearch(
	block_list* src, block_list* target, uint16 skill_lv, t_tick tick, int32 flag) const {
	...
	map_foreachinrange(skill_area_sub,
					   target,
					   this->getSplashSearchSize(skill_lv),
					   this->getSplashTarget(src),
					   src,
					   getSkillId(),
					   skill_lv,
...
int64 SkillImplRecursiveDamageSplash::splashDamage(
	block_list* src, block_list* target, uint16 skill_lv, t_tick tick, int32 flag) const {
